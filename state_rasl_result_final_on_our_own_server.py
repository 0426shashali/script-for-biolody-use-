...
import os,glob
outfile=open('/home/lss/project/compound_new/result/final_result_table3.fa','w')
input = glob.glob( '/home/lss/project/compound_new/result/*sam_3_result.fa' )
genelist=open('/home/lss/project/compound_new/mapping/probe_list.fa','r')
d={}
length=len(input)
for g in genelist:
    g=g.strip('\n')
